...
<head>
	<title>Student</title>
	<meta name="viewport" content="user-scalable=no, initial-scale=0.45, maximum-scale=0.45, minimum-scale=0.45, width=device-width, height=device-height, target-densitydpi=device-dpi" />
	...
	<script>
		$(function(){
			...
			$('#grid').flexigrid({
				url: 'http://gordoncollegeccs.edu.ph/ccswebsite/student/grades/functions/list3.php',
				dataType: 'json',
					buttons:[ 
